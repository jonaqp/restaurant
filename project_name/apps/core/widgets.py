...
from floppyforms import ClearableFileInput, RadioSelect
...
class CustomClearableFileInputOne(ClearableFileInput):
    template_name = 'themes/widgets/clearable_file_input_1.html'
